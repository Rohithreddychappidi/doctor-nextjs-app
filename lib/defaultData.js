...
// Cleaned for fresh live testing
...
export const DEFAULT_CONTENT = {
  home: {
    heroBanner: {
      tag: "NEONATOLOGY · PEDIATRICS · USCE TRAINING · RESEARCH",
  ...
  about: {
    ...
    photoUrl: "/images/dr-janardhan-mydam.jpg",
    ...
    sections: [
      { key: "employment", label: "Employment & Clinical Appointments", driveLink: "", items: [
        { title: "Chair of Pediatrics — Humboldt Park Health, Chicago, IL", meta: "2023 – Present", body: "Departmental executive leadership alongside clinical duties, including NICU and pediatric inpatient pathway formulation, quality-improvement governance, and maternal-infant safety initiatives." },
        { title: "Chair of Pediatrics Academics (Volunteer) — Windsor University School of Medicine, St. Kitts", meta: "Ongoing Academic Appointment", body: "Directs clinical curriculum development, lectures in pediatric pathophysiology, coordinates OSCE clinical examinations, and provides US residency application mentorship." },
        { title: "Attending Physician, Neonatal-Perinatal Medicine — John H. Stroger, Jr. Hospital of Cook County, Chicago, IL", meta: "2017 – Present", body: "Direct attending physician responsibility for high-acuity Level III NICU infants, delivery room resuscitations of extremely premature infants (22–24 weeks, ~400g), high-risk follow-up clinics, and daily medical fellow/resident teaching." },
        { title: "Neonatologist — Onsite Neonatal, PC and Midwest Neoped Associates", meta: "2021 – Present", body: "Additional NICU coverage across regional Midwestern hospitals, including Carle Health Methodist (Peoria), Northwestern Medicine Kishwaukee, and MacNeal Hospital." },
    ...
    journey: [
      { year: "1998", title: "MBBS, India", description: "Began his medical career after completing MBBS at NTR University of Health Sciences.", imageUrl: "" },
      { year: "1999", title: "Rotating Internship — Gandhi Medical College", description: "Clinical internship year across core specialties in India.", imageUrl: "" },
      { year: "2004", title: "MD Pediatrics, India", description: "Postgraduate pediatrics degree; university topper in Basic Sciences.", imageUrl: "" },
      { year: "2005", title: "Moved to the UK", description: "Began specialist pediatric training under the Royal College of Paediatrics and Child Health.", imageUrl: "" },
      { year: "2008", title: "USMLE & Move to the USA", description: "Scored in the 99th percentile on USMLE Step I and II, opening the path to US training.", imageUrl: "" },
      { year: "2010", title: "Pediatric Residency — Wayne State University, Detroit", description: "Trained in general and subspecialty pediatrics at Children's Hospital of Michigan.", imageUrl: "" },
      { year: "2013", title: "Neonatal-Perinatal Fellowship — Cook County, Chicago", description: "Fellowship training in neonatal-perinatal medicine at a major US safety-net hospital.", imageUrl: "" },
      { year: "2017", title: "Attending Physician, Neonatology", description: "Began practicing as an attending neonatologist in Chicago, caring for the region's most fragile newborns.", imageUrl: "" },
      { year: "2020", title: "Site PI, NIH-Funded PREMOD2 Trial", description: "Led a 19-center international trial on umbilical cord milking vs. delayed cord clamping.", imageUrl: "" },
      { year: "2023", title: "Chair of Neonatology & Pediatrics", description: "Appointed Chair of Neonatology and Pediatrics at Humboldt Park Health.", imageUrl: "" },
      { year: "Present", title: "From India, to the World", description: "Continuing clinical practice, research, and mentorship — free consultations for students and families everywhere.", imageUrl: "" },
    ],
    scholarProfile: {
      url: "https://scholar.google.com/citations?hl=en&tzom=-330&user=0mYhRK0AAAAJ",
      citations: 246,
      hIndex: 9,
      i10Index: 8,
    },
    // Approximate — read from the Google Scholar "Citations per year" chart,
    // not exact labeled values. Admin should verify/update against the real
    // numbers shown on the Scholar profile itself.
    citationsByYear: [
      { year: "2013", count: 2 },
      { year: "2014", count: 2 },
      { year: "2015", count: 3 },
  ...
  contact: {
    ...
    email: "admissions@jvmmedicalservices.com",
  },

  consultation: {
    eyebrow: "Attending Physician Mentorship · 1-on-1 Guidance",
    heading: "Schedule a Pre-Enrollment Consultation with Dr. Janardhan Mydam",
    body: "Before committing to a clinical tele-rotation, research cohort, or board preparation bank, speak directly with Dr. Janardhan Mydam, MD, FAAP. We discuss your academic credentials, US residency strategy, and tailor the right training pathway for your career.",
    supervisingDoctor: "Dr. Janardhan Mydam, MD, FAAP",
    formatNote: "15–30 Minute Private Video Conference via Microsoft Teams or Google Meet",
  },
};
